...
const inputClasses = "w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent transition-all duration-300 ease-in-out";
const labelClasses = "block text-gray-700 font-bold mb-2 transition-all duration-300 ease-in-out";
